...
# TEST
#
test_that("fg_bq_append_visit_type_info_to_service_sector_data_sql works", {

  skip_if(!bigrquery::bq_table_exists(tb_servicesector_combinations))

  tb_with_translations <- fg_bq_append_visit_type_info_to_service_sector_data_sql(project_id, tb_servicesector_combinations, fg_codes_info_table)
...
test_that("fg_bq_append_visit_type_info_to_service_sector_data_sql maps PRIM_OUT CODE5 CODE6", {
  ...
  # DEFAULT
  tb_with_translations <- fg_bq_append_visit_type_info_to_service_sector_data_sql(
...
test_that("fg_bq_append_visit_type_info_to_service_sector_data_sql maps hilmo CODE5", {
...
test_that("fg_bq_append_visit_type_info_to_service_sector_data_sql maps hilmo CODE98", {
...
test_that("fg_bq_append_visit_type_info_to_service_sector_data_sql overlap hilmo code5 CODE98", {
...
test_that("fg_bq_append_visit_type_info_to_service_sector_data_sql maps SOURCE", {
