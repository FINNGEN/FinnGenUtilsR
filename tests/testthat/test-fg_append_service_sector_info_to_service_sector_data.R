...
# TEST
#
test_that("fg_bq_append_service_sector_info_to_service_sector_data_sql works", {

  skip_if(!bigrquery::bq_table_exists(tb_servicesector_combinations))

  tb_with_translations <- fg_bq_append_service_sector_info_to_service_sector_data_sql(project_id, tb_servicesector_combinations, fg_codes_info_table)
...
test_that("fg_bq_append_service_sector_info_to_service_sector_data_sql maps PRIM_OUT CODE5 CODE6", {
  ...
  # DEFAULT
  tb_with_translations <- fg_bq_append_service_sector_info_to_service_sector_data_sql(
  ...
  res |>
    ...
    #dplyr::select(SOURCE, FG_CODE5, FG_CODE6, FG_CODE8, FG_CODE9, service_sector_concept_class_id, service_sector_code  ) |>
    dplyr::select(SOURCE, service_sector_concept_class_id, service_sector_code  ) |>
    expect_equal(
      tibble::tibble(
        SOURCE = "PRIM_OUT",
        service_sector_concept_class_id  = "SRC|Contact|Service",
        service_sector_code = c("PRIM_OUT|0|0", "PRIM_OUT|0|T40", "PRIM_OUT|R20|0", "PRIM_OUT|R20|T40", "PRIM_OUT|R20|T40")
      )
    )
...
test_that("fg_bq_append_service_sector_info_to_service_sector_data_sql maps hilmo CODE5", {
  ...
  res |>
    ...
    expect_equal(
      tibble::tibble(
        SOURCE = c('INPAT','OUTPAT','OPER_IN', 'OPER_OUT', 'INPAT','OUTPAT','OPER_IN', 'OPER_OUT'),
        service_sector_concept_class_id  = "SRC|ServiceSector",
        service_sector_code = c('INPAT|0','OUTPAT|0','OPER_IN|0', 'OPER_OUT|0', 'INPAT|1','OUTPAT|1','OPER_IN|93', 'OPER_OUT|93')
      )
    )
...
test_that("fg_bq_append_service_sector_info_to_service_sector_data_sql maps hilmo CODE98", {
  ...
  res |>
    ...
    expect_equal(
      tibble::tibble(
        SOURCE = "INPAT",
        service_sector_concept_class_id  = c("SRC|ServiceSector", "SRC|Contact|Urgency", "SRC|Contact|Urgency", "SRC|Contact|Urgency", "SRC|Contact|Urgency"),
        service_sector_code = c('INPAT|0','INPAT|0|3','INPAT|R80|0', 'INPAT|R80|3', 'INPAT|R80|3')
      )
    )
...
test_that("fg_bq_append_service_sector_info_to_service_sector_data_sql overlap hilmo code5 CODE98", {
  ...
  res |>
    ...
    expect_equal(
      tibble::tibble(
        SOURCE = "INPAT",
        service_sector_concept_class_id  = rep(c("SRC|ServiceSector", "SRC|Contact|Urgency", "SRC|Contact|Urgency", "SRC|Contact|Urgency"),2),
        service_sector_code = c('INPAT|0','INPAT|0|3','INPAT|R80|0', 'INPAT|R80|3', 'INPAT|1', 'INPAT|0|3', 'INPAT|R80|0', 'INPAT|R80|3')
      )
    )
  ...
  res |>
    ...
    expect_equal(
      tibble::tibble(
        SOURCE = "INPAT",
        service_sector_concept_class_id  = c("SRC|ServiceSector", "SRC|Contact|Urgency", "SRC|Contact|Urgency", "SRC|Contact|Urgency", "SRC|ServiceSector", "SRC|ServiceSector", "SRC|ServiceSector", "SRC|ServiceSector"),
        service_sector_code = c('INPAT|0','INPAT|0|3','INPAT|R80|0', 'INPAT|R80|3', 'INPAT|1', 'INPAT|1', 'INPAT|1', 'INPAT|1')
      )
    )
