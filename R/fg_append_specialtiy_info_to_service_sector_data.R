#' fg_append_specialtiy_info_to_service_sector_data_sql
#'
...
fg_append_specialtiy_info_to_service_sector_data_sql <- function(
  ...
  sql <- system.file("sql/append_speciality_info_to_service_sector_data.sql", package = "FinnGenUtilsR") |>
    SqlRender::readSql() |>
    SqlRender::render(
...
#' fg_bq_append_specialtiy_info_to_service_sector_data
#'
...
fg_bq_append_specialtiy_info_to_service_sector_data <- function(
    bq_project_id,
    bq_table,
    fg_codes_info_table,
    ...
  ...
  sql <- fg_append_specialtiy_info_to_service_sector_data_sql(
